        ...
        <Col span={24} {...(stepsVisible ? { md: 20 } : { md: 24 })}>
          ...
          {0 < step && stepsVisible && (
            <div style={{ margin: 'auto', width: 'fit-content' }}>
              <Button onClick={() => gotoNextStep(step - 1)}>后退</Button>
            </div>
          )}
        </Col>
      </Row>
  ...
  return (
    <>
      <Row className="call-to-action">
        <h2>列出一个项目</h2>
        <p>
        第一次在 Metaplex 上市？ <a>阅读我们的卖家指南。</a>
        </p>
      </Row>
          ...
          <Row>
            ...
            >
              <div>
                <div>出售现有项目</div>
                <div className="type-btn-description">
                出售您的 NFT 收藏中的现有物品，包括 Master NFT 
                </div>
              </div>
            </Button>
          </Row>
